...
#define MAP_OK 0 	    /* OK */
/*
 * Iterator is a pointer to a function that can take two void* arguments
 * and return an integer. Returns status code..
 */
typedef int (^Map_Iterator)(void*, void*);
...
method int Length(Map* const this);
...
method unsigned int HashInt(Map* const this, const char* keystring);
 ...
 */
method int Hash(Map* const this, const char* key)
{
 ...
 */
method int Put(Map* const this, const char* key, void* value)
{
 ...
 */
method void* Get(Map* const this, const char* key)
{
    void* result;
	/* Find data location */
	int curr = HashInt(this, key);
 ...
 */
method int ForEach(Map* const this, Map_Iterator f, void* item) 
{
	...
	for (int i = 0; i< this->tableSize; i++)
    {
        ...
        {
			void* data = (void*) (this->data[i].data);
...
method char* ToString(Map* const this)
{
